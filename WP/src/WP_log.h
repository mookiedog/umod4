...
//#include "ECU_log.h"
#define LOG_ECU_LAST_ADDR (0x00DF)

#define LOG_WP_BASE     ((LOG_ECU_LAST_ADDR)+1)

#define LOG_CSECS       ((LOG_WP_BASE) + 0x0000)
#define LOG_CSECS_LEN   1

#define LOG_SECS        ((LOG_WP_BASE) + 0x0001)
#define LOG_SECS_LEN    1

#define LOG_MINS        ((LOG_WP_BASE) + 0x0002)
#define LOG_MINS_LEN    1

#define LOG_HOURS       ((LOG_WP_BASE) + 0x0003)
#define LOG_HOURS_LEN   1

#define LOG_DATE        ((LOG_WP_BASE) + 0x0004)
#define LOG_DATE_LEN    1

#define LOG_MONTH       ((LOG_WP_BASE) + 0x0005)
#define LOG_MONTH_LEN   1

#define LOG_YEAR        ((LOG_WP_BASE) + 0x0006)
#define LOG_YEAR_LEN    1

#define LOG_FIXTYPE     ((LOG_WP_BASE) + 0x0007)
...
#define LOG_PV          ((LOG_WP_BASE) + 0x0008)
...
#define LOG_WR_TIME     ((LOG_WP_BASE) + 0x0010)
#define LOG_WR_TIME_LEN 2
#define LOG_SYNC_TIME   ((LOG_WP_BASE) + 0x0011)
